    ...
    def __init__(
        ...
        for l in range(num_layers) :
            ...
            for i in range(num_tasks):
                ...
                mask_l_t = mask_interface.get_mask(layer_id=l, task_embedding=e_k[0], topk=19) # 得到第 i 层第t个任务的初始掩码
        ...
        # 未将mask传入metapolicy中 0424
        
        

        actor_def = policies.MetaPolicy( **actor_configs,task_mask=mask_dict)
